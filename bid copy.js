...
const blackListType = ["clearance", "hybrid", "onsite", "adult", "india", "slack"];
...
window.addEventListener("load", function () {
	const observer = new MutationObserver(async (mutations) => {
		let proposal = document.getElementById("descriptionTextArea");
		navigator.clipboard.readText().then(text => {
			if (proposal !== null) proposal.value = text;
		}).catch(err => {
